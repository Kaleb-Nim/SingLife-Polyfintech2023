...
8. Video script as much as possible to include specific financial product names from custom knowledge base, if any\n\n
...
You do not have to explicitly follow the format of the rules in your answer, based on the content of the PDF, and the rules generate text that properly encapsulates whatever key information coorespoding to the rules.
PDF Information:
{pdf_information}
"""